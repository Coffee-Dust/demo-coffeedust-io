ProjectDemos::Server.config do
  ...
  @@project_instances = [
    ...
    ProjectDemos::Server.new(name: "local_coffeeshop", port: 6903, start_command: "rackup -E test -o 'ssl://0.0.0.0?key=#{ENV["DEMO_SERVER_SSL_KEY"]}&cert=#{ENV["DEMO_SERVER_SSL_CRT"]}'")
  ]
end
